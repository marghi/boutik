...
(function (root, factory) {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      ...
      skipLabel: '<i class="icon-remove"></i> Fermer',
      /* Done button label in tooltip box */
      doneLabel: '<i class="icon-ok"></i> Términé',
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      ...
      self._lastShowElementTimer = setTimeout(function() {
        ...
        oldtooltipLayer.innerHTML = targetElement.intro.toString().replace(/xyz/g, "<br>").replace(/icon-trash/g, "<i class='icon-trash'></i>");
