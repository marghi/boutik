...
var notSupportedBrowsers = [{'os': 'Any', 'browser': 'Safari', 'version': 3},{'os': 'Any', 'browser': 'MSIE', 'version': 7}, {'os': 'Any', 'browser': 'Firefox', 'version': 10}];
...
var BrowserDetection = {
	...
	writeNoticeCode: function(){
		...
		code += '<ul class="bd-browsers-list" style="">';
	...
	noticeText: {
    	   'professional': { "title": "Navigateur obsolète détecté", "notice": "Notre système a détecté que vous utilisez un navigateur obsolète. Une mise à jour est nécessaire pour vous permettre d'accéder au site Web. Veuillez contacter votre responsable SI pour faire la mise à jour ou télécharger un nouveau navigateur à l'aide des liens ci-dessous.", "selectBrowser": "Utilisez les liens ci-dessous pour télécharger un nouveau navigateur ou mettre à jour votre navigateur actuel.", "remindMeLater": "Rappelez-moi plus tard", "neverRemindAgain": "Jamais" },
