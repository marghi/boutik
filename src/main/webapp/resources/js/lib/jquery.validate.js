...
$.extend($.validator, {
	...
	messages: {
		...
		accept: "Veuillez choisir un fichier valide (.txt).",
	...
	prototype: {
		...
		showLabel: function(element, message) {
			...
			if ( label.length ) {
				...
				// create label
				// création label validation si le champ est password ou username 
				if ((this.idOrName(element)=="j_password")|| (this.idOrName(element)=="j_username")){
